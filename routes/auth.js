...
app.post('/api/auth/signup', async (req, res) => {
    ...
    try {
        ...
        const userRes = await db.query('INSERT INTO users (name, email, password, phone, "monthlyContribution", "createdAt") VALUES ($1, $2, $3, $4, $5, $6) RETURNING id', [fullName, email, hashedPassword, phone, monthlyContribution, date]);
