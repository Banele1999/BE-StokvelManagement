...
app.post('/api/payments', authenticateToken, upload.single('proof'), async (req, res) => {
    ...
    try {
        const payRes = await db.query('INSERT INTO payments ("userId", "groupId", amount, method, date, reference, status, "proofPath") VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING id', [req.user.id, groupId, amount, method, date, reference, 'pending', proofPath]);
